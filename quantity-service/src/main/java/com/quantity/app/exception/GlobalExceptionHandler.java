...
/**
 * Converts exceptions thrown by measurement-service into structured JSON responses.
 */
@Slf4j
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleDomain(QuantityMeasurementException ex) {
