...
/**
 * Data Transfer Object returned by every REST endpoint.
 * Maps directly to / from {@link QuantityMeasurementEntity} through the
 * static factory helpers, keeping the API layer decoupled from persistence.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
public class QuantityMeasurementDTO {
    ...
    /** Convert this DTO back to a new (unpersisted) entity. */
